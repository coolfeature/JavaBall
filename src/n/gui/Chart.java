...
/**
 * This class displays the referee allocations in the form of a bar chart.
 */
public class Chart extends JComponent {
	...
	private void paintBar(Graphics2D g, int x, Referee referee){
		...
		g.drawString(referee.getId(), x, bottom+20);
		g.drawString("" + referee.getAllocations(), x, barTop - 12);
	}
